...
/***/ 42:
/*!******************************************************************************************************!*\
  !*** /Users/dalong/Documents/1/uniapp/miniprogram/gamezzz/main.js?{"page":"pages%2Fcenter%2Findex"} ***!
  \******************************************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/center/index.vue */ 43));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 43:
/*!***********************************************************************************!*\
  !*** /Users/dalong/Documents/1/uniapp/miniprogram/gamezzz/pages/center/index.vue ***!
  \***********************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_template_id_0f3320de___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=0f3320de& */ 44);
...
/***/ 44:
/*!******************************************************************************************************************!*\
  !*** /Users/dalong/Documents/1/uniapp/miniprogram/gamezzz/pages/center/index.vue?vue&type=template&id=0f3320de& ***!
  \******************************************************************************************************************/
...
/***/ 46:
/*!************************************************************************************************************!*\
  !*** /Users/dalong/Documents/1/uniapp/miniprogram/gamezzz/pages/center/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default =
{
  ...
  methods: {
    // 获取小程序设置
    getSystemSetting: function getSystemSetting() {var _this = this;
      if (getApp().globalData.setting) {
        this.centerCouponEnter = getApp().globalData.setting.center_coupon_enter;
      } else {
        this.$getR('/api/getMiniProgramSetting').then(function (res) {
          _this.systemSetting = res.info.center_coupon_enter;
          getApp().globalData.setting = res.info;
        });
      }
    },
    // 获取用户信息
    getUserInfo: function getUserInfo(action) {
      var that = this;
      uni.getUserProfile({
        desc: '显示用户个人信息',
        success: function success(res) {
          that.$postR('/api/setWechatUserInfo', res).then(function (res) {
            if (res.status === 'success') {
              var toastText = res.info;
              if (action === 'update') {
                toastText = '更新成功';
              } else if (action === 'init') {
                toastText = '完善成功';
    ...
    getIncomeInfo: function getIncomeInfo() {var _this2 = this;
      this.$getR('/api/income').then(function (res) {
        _this2.userInfo = res.info.user_info;
        if (!res.info.user_info.nickname) {
          _this2.authizeBtnDisplay = true;
        } else {
          _this2.authizeBtnDisplay = false;
        }
        _this2.totalIncome = res.info.total_income,
        _this2.withdrawalsTotal = res.info.withdrawals_total,
        _this2.leftIncome = res.info.left_income;
        _this2.todayIncome = res.info.today_income;
        _this2.coinTotal = res.info.coin_total;
      });
...
/***/ 48:
/*!********************************************************************************************************************!*\
  !*** /Users/dalong/Documents/1/uniapp/miniprogram/gamezzz/pages/center/index.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
